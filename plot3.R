...
par(mfrow=c(1,1))
plot(subset1$datetime, subset1$Sub_metering_1, ylab="Energy sub metering",xlab="",type="l")
lines(subset1$datetime,subset1$Sub_metering_2,type="l",col="red")
lines(subset1$datetime,subset1$Sub_metering_3,type="l",col="blue")
